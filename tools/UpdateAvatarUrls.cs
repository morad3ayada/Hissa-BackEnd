...
const string connStr = "Server=db59823.databaseasp.net;Database=db59823;User Id=db59823;Password=3Zd=w-X97x!C;Encrypt=False;MultipleActiveResultSets=True;";
