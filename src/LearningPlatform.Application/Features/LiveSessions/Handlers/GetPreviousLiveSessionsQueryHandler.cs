...
public class GetPreviousLiveSessionsQueryHandler(ILiveSessionAccessService accessService)
    : IRequestHandler<GetPreviousLiveSessionsQuery, PaginatedResponse<LiveSessionDto>>
{
    public async Task<PaginatedResponse<LiveSessionDto>> Handle(GetPreviousLiveSessionsQuery request, CancellationToken cancellationToken)
    {
