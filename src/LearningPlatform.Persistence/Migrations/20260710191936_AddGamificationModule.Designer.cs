...
namespace LearningPlatform.Persistence.Migrations
{
    ...
    [Migration("20260710191936_AddGamificationModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearningPlatform.Domain.Entities.GamificationLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("GamificationLevels", (string)null);
            ...
            modelBuilder.Entity("LearningPlatform.Domain.Entities.GamificationProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("AvatarGender")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
                    ...
                    b.Property<DateTime?>("LastDailyLoginRewardAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("LearningPlatform.Domain.Entities.PointsTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("StudentId", "Reason", "SourceId")
                        .IsUnique()
            ...
            modelBuilder.Entity("LearningPlatform.Domain.Entities.Reward", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Passed your very first quiz.",
                            IsDeleted = false,
                            Name = "First Quiz",
                            PointsValue = 20,
                            TriggerType = "FirstQuizPassed",
                            Type = "Badge"
                        },
                        new
                        {
                            ...
                            Name = "First Course",
                            PointsValue = 50,
                            TriggerType = "FirstCourseCompleted",
                            Type = "Badge"
                        },
                        new
                        {
                            ...
                            PointsValue = 30,
                            TriggerType = "TenLessonsCompleted",
                            Type = "Badge"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Reached a new gamification level.",
                            IsDeleted = false,
                            Name = "Level Up",
                            PointsValue = 10,
                            TriggerType = "LevelUp",
            ...
            modelBuilder.Entity("LearningPlatform.Domain.Entities.Challenge", b =>
                {
                    b.HasOne("LearningPlatform.Domain.Entities.ApplicationUser", "Challenger")
                        .WithMany()
                        .HasForeignKey("ChallengerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LearningPlatform.Domain.Entities.ApplicationUser", "Opponent")
                        .WithMany()
                    ...
                    b.HasOne("LearningPlatform.Domain.Entities.ApplicationUser", "Winner")
                        .WithMany()
            ...
            modelBuilder.Entity("LearningPlatform.Domain.Entities.GamificationProfile", b =>
                {
                    b.HasOne("LearningPlatform.Domain.Entities.ApplicationUser", "Student")
                        ...
                        .HasForeignKey("LearningPlatform.Domain.Entities.GamificationProfile", "StudentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
