        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wallets_Users_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletRequests_Users_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletRequests_Status",
                table: "WalletRequests",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_WalletRequests_WalletId_Status",
                table: "WalletRequests",
                columns: new[] { "WalletId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Wallets_StudentId_Unique",
                table: "Wallets",
                column: "StudentId",
                unique: true);
